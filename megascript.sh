...
sourcePath="$HOME/Documents/B0nyKB/Blog/"
destinationPath="$HOME/Documents/B0nyBlog/content/posts"

# Set GitHub Repo
myrepo="ignacio1224.githug.io"
...
if ! git push origin github-deploy:github --force; then
    echo "Failed to push to github branch."
    git branch -D github-deploy
    exit 1
fi
